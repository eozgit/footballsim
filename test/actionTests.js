...
function runTest() {
  ...
  mocha.describe('noBallNotGK2CloseBallBottomTeam()', function () {
    mocha.it(
      'Nobody has the ball, not GK, in bottom Goal (own), run or sprint towards the ball',
      async () => {
    ...
    mocha.it(
      'A Player has the ball, not GK, in bottom Goal (own), tackle, slide, run or sprint',
      async () => {
    ...
    mocha.it(
      'A Player has the ball, not GK, not in bottom Goal (own), run or sprint towards the ball',
      async () => {
        let matchDetails = { ball: { withPlayer: false } };
        let parameters = actions.noBallNotGK2CloseBallBottomTeam(
          matchDetails,
    ...
    mocha.it(
      'A Player has the ball, not GK, not in bottom Goal (own), tackle, intercept and slide',
      async () => {
        let matchDetails = { ball: { withPlayer: true } };
        let parameters = actions.noBallNotGK2CloseBallBottomTeam(
          matchDetails,
  ...
  mocha.describe('noBallNotGK2CloseBall()', function () {
    mocha.it(
      'Nobody has the ball, not GK, in top Goal (own), run or sprint towards the ball',
      async () => {
        let matchDetails = { ball: { withPlayer: false } };
    ...
    mocha.it(
      'Player has the ball, not GK, in top Goal (own), tackle, slide, run or sprint',
      async () => {
        let matchDetails = { ball: { withPlayer: true } };
        let parameters = actions.noBallNotGK2CloseBall(
          matchDetails,
    ...
    mocha.it(
      'Player has the ball, not GK, in top Goal (not own), tackle, intercept and slide',
      async () => {
        let matchDetails = { ball: { withPlayer: true } };
        let parameters = actions.noBallNotGK2CloseBall(
          matchDetails,
    ...
    mocha.it(
      'Nobody has the ball, not GK, not in top Goal (own), run or sprint towards the ball',
      async () => {
        let matchDetails = { ball: { withPlayer: false } };
        let parameters = actions.noBallNotGK2CloseBall(
          matchDetails,
    ...
    mocha.it(
      'Player has the ball, not GK, not in top Goal (own), tackle, intercept and slide',
      async () => {
        let matchDetails = { ball: { withPlayer: true } };
        let parameters = actions.noBallNotGK2CloseBall(
          matchDetails,
  ...
  mocha.describe('bottomTeamPlayerHasBallInTopPenaltyBox()', function () {
    mocha.it(
      'Top Box Close, not within space of goal, no opposition, no team mate, half/shooting skill from goal',
      async () => {
        ...
        let parameters = actions.bottomTeamPlayerHasBallInTopPenaltyBox(
          matchDetails,
          player,
          team,
          opposition
    ...
    mocha.it(
      'Top Box Close, not within space of goal, no opposition, no team mate, 0/half skill from goal',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBox.json'
        );
    ...
    mocha.it(
      'In Top Box Close, No opposition ahead, no close team mate, further than shooting skill distance from goal',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBox.json'
        );
    ...
    mocha.it(
      'In Top Box Not close, No opposition ahead, no close team mate, further than shooting skill distance from goal',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBox.json'
        );
    ...
    mocha.it(
      'In Top Box Not close, No opposition ahead, no close team mate, within shooting skill distance from goal',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBox.json'
        );
    ...
    mocha.it(
      'In Top Box Close, player ahead, no close team mate, 0/half of shooting range',
      async () => {
        let matchDetails = await common.readFile(
    ...
    mocha.it(
      'In Top Box Not Close, player ahead, no close team mate, half/full shooting range ',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoal.json'
        );
    ...
    mocha.it(
      'In Top Box Not Close, player ahead, no close team mate, further than shooting',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoal.json'
        );
    ...
    mocha.it(
      'In Top Box Close, not in goal space, no player ahead, close team mate, 0/half of shooting range',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoal.json'
        );
    ...
    mocha.it(
      'In Top Box Close, not in goal space, no player ahead, close team mate, half/shooting range',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoal.json'
        );
    ...
    mocha.it(
      'In Top Box Close, not in goal space, no player ahead, close team mate, < shooting range',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoal.json'
        );
    ...
    mocha.it(
      'In Top Box Close, no player ahead, close team mate, 0/half of shooting range',
      async () => {
        let matchDetails = await common.readFile(
    ...
    mocha.it(
      'In Top Box Close, no player ahead, close team mate, half/shooting range',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoalLess25.json'
        );
    ...
    mocha.it(
      'In Top Box Close, no player ahead, close team mate, over shooting range',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoalLess25.json'
        );
    ...
    mocha.it(
      'In Top Box Close, opp. near, no player ahead, no close team mate, 0/half shooting range',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoalLess25.json'
        );
    ...
    mocha.it(
      'In Top Box Close, opp. near, no player ahead, no close team mate, half/shooting range',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoalLess25.json'
        );
    ...
    mocha.it(
      'In Top Box Close, opp. near, no player ahead, no close team mate, over shooting range',
      async () => {
        let matchDetails = await common.readFile(
          'test/input/actionInputs/bottomTeamHasBallInTopPenaltyBoxWithinGoalLess25.json'
        );
