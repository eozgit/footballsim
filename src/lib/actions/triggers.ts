...
export function ballKicked(matchDetails: MatchDetails, team: Team, player: Player): [number, number] {
  return executeKickAction(matchDetails, team, player);
}


export function penaltyTaken(matchDetails: MatchDetails, team: Team, player: Player): [number, number] {
  return executePenaltyShot(matchDetails, team, player);
}



export function throughBall(matchDetails: MatchDetails, team: Team, player: Player): [number, number] {
